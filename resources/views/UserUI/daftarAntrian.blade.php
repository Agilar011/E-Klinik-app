                    ...
                    <div class="hidden md:flex md:items-center md:space-x-6">
                        ...
                        <div class="container mx-auto">
                            ...
                            <div class="relative inline-block text-right">
                              <div>
                                <button type="button" class="inline-flex item-center justify-center bg-blue-400 hover:text-blue-700 font-semibold text-black" id="menu-button" aria-expanded="false" aria-haspopup="true" onclick="toggleDropdown()" style="font-family: sans-serif;">
                                  Medical Services
                                  <svg class="h-6 text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
