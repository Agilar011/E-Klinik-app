            ...
            <div class="overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-5 lg:p-5 bg-gray-200 border-b border-gray-200 justify-center ">
                    <div class="bg-white border-b border-gray-200 sm:rounded-lg">
                        <div class="flex p-5 my-auto gap-4 justify-between">
                                            ...
                                            <x-dropdown align="right" width="w-auto">
                                                ...
                                                <x-slot name="content">
                                                    <div name="box" class="bg-gray-400 ">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('SetDefaultUser', $id) }}">
                                                            @csrf
                                                            <button type="submit"
                                                                onclick="return confirm('Are you sure you want to reset password this account?')"
