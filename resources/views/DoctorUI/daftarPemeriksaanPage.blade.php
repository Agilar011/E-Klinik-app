                                ...
                                @foreach ($pengajuan as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="{{ route('pemeriksaanPage', $item->id) }}" class="bg-green-500 text-white px-4 py-2 text-center text-sm font-semibold rounded-lg shadow-md hover:bg-green-600">Lakukan Pemeriksaan</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
