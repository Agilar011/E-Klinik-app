    <div class="p-6 lg:p-8 bg-white border-b border-gray-200 h-full" style="background: url('/images/GmrQcB.jpg') no-repeat center center fixed; background-size: cover;">
