<div class="p-6 lg:p-8 bg-gray-400 border-b border-gray-200 grid justify-center items-center "
    style="background-image: url('/images/tem-bg1.jpg')">
    {{-- <x-application-logo class="block h-12 w-auto" /> --}}


    <h1 class="mt-8 text-4xl font-medium text-gray-900">
        @auth
    ...
    <div class="mt-6 text-2xl text-gray-800 max-w-[830px] text-center">
